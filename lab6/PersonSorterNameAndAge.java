...
{
	public int compare(Person other,Person here){
		
		return other.getAge()- here.getAge();
	}
}
	
	
	Arrays.sort(persons, new age());
...
//-----------------End here. Please do not remove this comment. Reminder: no changes outside the todo regions.
{
    ...
    */    
    ...
    public int compareTo(Person other){
		...
		list.add(other.getLastName());
		list1.add(this.getFirstName());
		list1.add(other.getFirstName());
		Collections.sort(list);
		Collections.sort(list1);
		if (lastName.equals(other.getLastName()) & firstName.equals(other.getFirstName()))
			return 0;
		else if((list.get(0).equals(lastName)& !lastName.equals(other.getLastName()))| (lastName.equals(other.getLastName())&list1.get(0).equals(firstName)))
			return -1;
		else
			return 1;
	}
