...
class FillInQuestion extends Question
{
   ...
   */
   public FillInQuestion(String questionText)
   {
       ...
       String ans = questionText.substring(start+1, end);
       ...
       String ans1 = ans.replaceAll(".", "_");
		
       //6. replace answer embedded in questionText with the underscores before setting text string
       String questionText1 = questionText.substring(0, start+1)+ ans1+ questionText.substring(end , questionText.length());
	   
       //7. setQuestion to set text variable
       setQuestion (questionText1);
